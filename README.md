...
Uma plataforma que você roda na sua própria infraestrutura para expor números de WhatsApp como uma API REST completa:

- **Multi-tenant com isolamento por número:** o operador da plataforma cria tenants; cada tenant é um admin que gerencia seus próprios números (instâncias). Cada instância tem suas próprias API keys e webhooks — credenciais de um número nunca afetam os demais.
